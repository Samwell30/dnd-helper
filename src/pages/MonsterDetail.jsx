...
const MonsterDetail = () => {
  ...
  // Handle speed property (if it's an object)
  const renderSpeed = () => {
    ...
    return monster.speed; // If it's a string, return it directly
  };
  ...
  return (
    <div>
      ...
      <p><strong>Speed:</strong> {renderSpeed()}</p>
      <p><strong>Armor:</strong> {Array.isArray(monster.armor_class) ? monster.armor_class.map(ac => ac.value).join(', ') : monster.armor_class}</p>
      <div>
